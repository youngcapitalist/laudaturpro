...
export const YO_CHECKUP_STEPS = [
  {
    ...
    options: [
      { id: "fall2026", label: "Syksy 2026", hint: "Kokeet 14.–30.9.2026 — valmistautuminen kannattaa aloittaa nyt." },
      { id: "spring2027", label: "Kevät 2027", hint: "Aikaa on enemmän — rytmi kannattaa silti aloittaa ajoissa." },
    ],
  },
  {
    id: "weekly_hours",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "unsure", label: "Epävarmalta tuntuu", hint: "En aina tiedä, mistä aloittaa tai mitä harjoitella." },
  ...
  },
  {
    ...
    subtitle: "Tämän avulla näemme, mihin kohtaan suunnitelmassa kannattaa panostaa.",
    options: [
