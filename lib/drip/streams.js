    ...
    steps: [
      // 1. Vastavuoroisuus + sitoutuminen: ilmaista arvoa ja omat vastaukset takaisin.
      {
        ...
        body: (p) => {
          ...
          return (
            (recap
              ? `Suunnitelmasi (${recap}) on valmis — rakennettu juuri sinulle, ei kenellekään muulle.<br><br>`
              : "Suunnitelmasi on valmis — rakennettu juuri sinulle, ei kenellekään muulle.<br><br>") +
        ...
        urgency: (p) =>
          p.priceEur
            ? `Henkilökohtainen hintasi ${p.priceEur} € — ei julkisesti saatavilla.`
            : null,
      ...
      // 2. Johdonmukaisuus + auktoriteetti: oma tavoite ja YTL:n aikataulu.
      {
        ...
        body: (p) => {
          ...
          return (
            `Tavoitteesi ${goal} ei toteudu itsestään — mutta se toteutuu suunnitelmalla, ` +
        ...
        bullets: [
          "Henkilökohtainen hinta — et saa samaa tarjousta uudelleen",
        ...
        body: (p) =>
          p.rescuePriceEur
            ? `Tämä on viimeinen viestimme — sen jälkeen suunnitelmasi ja hintasi poistuvat.<br><br>` +
              `Annamme kertaluonteisen <strong>-${p.rescuePct} %</strong> alennuksen ` +
              `henkilökohtaisesta hinnastasi: <strong>${p.rescuePriceEur} €</strong> (aiemmin ${p.originalPriceEur} €). ` +
              `Tätä hintaa ei toisteta.<br><br>` +
              `Linkki on voimassa 7 päivää — sen jälkeen palaat listahintaan.`
