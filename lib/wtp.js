...
export const LAUDATUR_WTP_QUESTIONS = [
  {
    id: "budget",
    q: "Kuinka paljon olet valmis panostamaan yo-valmennukseen, jotta tavoite toteutuu?",
    options: [
      {
        label: "Alle 100 €",
        hint: "Haen tehokasta tukea yhteen tai kahteen aineeseen.",
        points: 90,
      },
      {
        label: "100–200 €",
        hint: "Olen valmis sijoittamaan laadukkaaseen valmennukseen.",
        points: 220,
      },
      {
        label: "200–350 €",
        hint: "Haluan kattavan tuen useaan aineeseen.",
        points: 520,
      },
      {
        label: "350–500 €",
        hint: "Haluan parhaat työkalut ilman kompromisseja.",
        points: 820,
      },
      {
        label: "Yli 500 €",
        hint: "Panostan täysillä tavoitteeseen.",
        points: 1000,
      },
    ],
  },
  {
    id: "dream",
    q: "Kuinka tärkeää on päästä unelmiesi opiskelupaikkaan yo-arvosanoilla?",
    options: [
