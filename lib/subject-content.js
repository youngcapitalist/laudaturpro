...
/** Harkkakokeet avautuvat lähempänä syksyn 2026 yo-koetta. */
export const HARKKAKOE_OPENS = "2026-08-18";

export function isHarkkakoeOpen() {
  return new Date() >= new Date(`${HARKKAKOE_OPENS}T00:00:00+03:00`);
}
...
export const SUBJECT_CONTENT = {
  ...
  "matikka-lyhyt": {
    ...
    topics: [
      ...
      { title: "Funktiot", body: "Suora, paraabeli ja eksponentti — lue kuvaajaa ja tulkitsi kontekstissa." },
